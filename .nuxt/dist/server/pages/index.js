...
module.exports = __webpack_require__.p + "img/icon_12_03_01.180c906.png";
...
module.exports = __webpack_require__.p + "img/icon_12_03_left.b80691e.png";
...
module.exports = __webpack_require__.p + "img/icon_12_03_right.c9ee43e.png";
...
/* harmony default export */ var lib_vue_loader_options_pagesvue_type_script_lang_js_ = ({
  ...
  mounted() {
    ...
    if (this.mobileStatus) {// new Swiper(".swiper-containers", {
  ...
  watch: {
    ...
    mobileStatus() {
      ...
      this.$nextTick(() => {
        if (this.mobileStatus) {
          that.getSw(); //   new Swiper(".swiper-containers", {
          //     updateOnWindowResize: true,
          //     autoplay: {
          //       delay: 3000, // 设置轮播的时间
          //       disableOnInteraction: false // 这一行是为了避免手动滑动轮播图后，自动轮播失效，默认为true
